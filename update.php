...
if (isset($_GET['id'])) {
    ...
    //$sql = "SELECT * FROM rcl_order WHERE rcl_id = $rcl_id "; 
    //$sql = "SELECT * FROM rcl_order INNER JOIN shopify_order ON rcl_order.order_id = shopify_order.order_name WHERE rcl_id = $rcl_id"; 
